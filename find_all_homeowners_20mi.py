...
DAYS         = 365
BATCH_SIZE   = 1000
OUTPUT_FILE  = "app/public/all_homeowners_20mi.csv"
...
ENTITY_RE = re.compile(
    r"\b("
    # Corporate / fund / LLC entities
    r"LLC|INC|CORP|LTD|LP|LLP|TRUST|TRUSTEE|TRS|"
    r"PROPERTIES|PROPERTY|HOLDINGS|REALTY|GROUP|FUND|"
    r"FOUNDATION|SERIES|CONSERVE|BUILDWELL|ENTERPRISES|PARTNERS|"
    # HOA / civic / nonprofit
    r"ASSOCIATION|ASSN|ASSOC|HOA|HOMEOWNERS|OWNERS|"
    r"AUTHORITY|COMMISSION|DEPARTMENT|UTILITIES|UTILITY|"
    r"CEMETERY|VFD|INTERNATIONAL|FELLOWSHIP|"
    # Fiduciary / estate
    r"EXEC|EXECUTOR|EXECUTRIX|ADMINISTRATOR|ADMR|HEIRS?|ESTATE|"
    # Road suffixes (rarely surnames)
    r"ROAD|RD|STREET|AVENUE|AVE|DRIVE|DR|BOULEVARD|BLVD|"
    r"HIGHWAY|HWY|PARKWAY|PKWY|TERRACE|WAY|CIRCLE|CIR|"
    # Place / subdivision words (verified non-surname in this dataset)
    r"COUNTRY|VISTA|RIDGE|GROVE|MEADOW|VALLEY|ESTATES|"
    r"VILLAGE|CROSSING|POINTE|COMMONS|RESERVE|HEIGHTS|LANDING"
    r")\b|"
    # Phrase patterns
    r"\b(CITY|TOWN|COUNTY)\s+OF\b|"
    r"\bFRIENDS\s+OF\b|"
    r"\bET\s+AL\b",
    re.IGNORECASE,
)
